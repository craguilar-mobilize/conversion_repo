...
CREATE OR REPLACE PROCEDURE PUBLIC.InsertDemoUsers (in_Name VARCHAR, in_Birthday TIMESTAMP, in_CityCode INTEGER, in_Email VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS
...
CREATE OR REPLACE PROCEDURE PUBLIC.UpdateDemoUsers (in_id INTEGER, in_Name VARCHAR, in_Birthday TIMESTAMP, in_CityCode INTEGER, in_Email VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS
